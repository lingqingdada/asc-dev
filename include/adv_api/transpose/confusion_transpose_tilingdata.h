...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONFUSION_TRANSPOSE_TILINGDATA_H__
#endif
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONFUSION_TRANSPOSE_TILINGDATA_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_CONFUSION_TRANSPOSE_TILINGDATA_H__
#endif