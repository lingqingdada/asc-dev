...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_RMSNORM_TILING_INTF_H__
#endif
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_RMSNORM_TILING_INTF_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_RMSNORM_TILING_INTF_H__
#endif