...
/*!
 * \file dequantize_tiling.h
 * \brief
 */

#if !defined(__ASCENDC_INCLUDE_INTERNAL_HEADERS__)
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DEQUANTIZE_TILING_H__
#endif

#ifndef LIB_QUANTIZATION_DEQUANTIZE_TILING_H
#define LIB_QUANTIZATION_DEQUANTIZE_TILING_H
#include <cstdint>
...
/*!
 * \brief calculate max and min tmp buffer size for Dequantize interface.
...
/*!
 * \brief The calculation of the Dequantize interface requires the developer to reserve or apply for temporary space.
...
#endif // LIB_QUANTIZATION_DEQUANTIZE_TILING_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DEQUANTIZE_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DEQUANTIZE_TILING_H__
#endif