...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_HYPOT_TILING_H__
#endif

#ifndef LIB_MATH_HYPOT_TILING_H
#define LIB_MATH_HYPOT_TILING_H
#include <cstdint>
...
/*!
 * \brief The calculation of the Hypot interface requires the developer to reserve or apply for temporary space. The
...
#endif // LIB_MATH_HYPOT_TILING_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_HYPOT_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_HYPOT_TILING_H__
#endif