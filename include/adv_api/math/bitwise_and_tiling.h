...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_AND_TILING_H__
#endif

#ifndef LIB_MATH_BITWISE_AND_TILING_H
#define LIB_MATH_BITWISE_AND_TILING_H
...
/*!
 * \brief The calculation of the BitwiseAnd interface requires the developer to reserve or apply for temporary space.
...
#endif  // LIB_MATH_BITWISE_AND_TILING_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_AND_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_AND_TILING_H__
#endif