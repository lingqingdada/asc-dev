...
/*!
 * \file bitwise_not_tiling.h
 * \brief
 */

#if !defined(__ASCENDC_INCLUDE_INTERNAL_HEADERS__)
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_NOT_TILING_H__
#endif

#ifndef LIB_MATH_BITWISE_NOT_TILING_H
#define LIB_MATH_BITWISE_NOT_TILING_H
...
#endif // LIB_MATH_BITWISE_NOT_TILING_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_NOT_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_NOT_TILING_H__
#endif