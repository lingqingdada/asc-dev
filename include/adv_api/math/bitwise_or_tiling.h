...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_OR_TILING_H__
#endif

#ifndef LIB_MATH_BITWISE_OR_TILING_H
#define LIB_MATH_BITWISE_OR_TILING_H
 ...
 */
void GetBitwiseOrMaxMinTmpSize(const platform_ascendc::PlatformAscendC& ascendcPlatform, const ge::Shape& srcShape,
 ...
 */
void GetBitwiseOrTmpBufferFactorSize(const platform_ascendc::PlatformAscendC& ascendcPlatform, const uint32_t typeSize,
                                     uint32_t& maxLivedNodeCount, uint32_t& extraBuf);
} // namespace AscendC
#endif // LIB_MATH_BITWISE_OR_TILING_H

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_OR_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_BITWISE_OR_TILING_H__
#endif