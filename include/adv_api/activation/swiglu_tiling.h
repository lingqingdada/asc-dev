...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_SWIGLU_TILING_H__
#endif
...
/*!
 * \brief The calculation of the SwiGLU interface requires the developer to reserve or apply for temporary space. The
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_SWIGLU_TILING_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_SWIGLU_TILING_H__
#endif