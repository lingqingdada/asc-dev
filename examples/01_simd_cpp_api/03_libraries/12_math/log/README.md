...
本样例演示了基于Log高阶API的算子实现。样例按元素以e、2、10为底做对数运算。
...
- 算子规格：  
  <table>
  <tr><td rowspan="1" align="center">算子类型(OpType)</td><td colspan="4" align="center"> log </td></tr>
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">log_custom</td></tr>
  </table>
