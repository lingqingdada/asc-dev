...
分核AIC、AIV融合编程实现，主要介绍了Matmul高阶API的MIX模式，Matmul API内部会自动控制AIC、AIV的核间同步。
...
│   └── matmul_fused.asc        // Ascend C样例实现 & 调用样例
```
...
- 样例规格：  
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="5" align="center">matmul_fused_custom</td></tr>
  </table>
