...
本样例基于SetNextTaskStart接口实现Superkernel的子kernel并行。
...
│   └── set_next_task_start.asc   // Ascend C算子实现 & 调用样例
```
...
- 算子规格：  
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">kernel_set_next_task_start</td></tr>  
  </table>
