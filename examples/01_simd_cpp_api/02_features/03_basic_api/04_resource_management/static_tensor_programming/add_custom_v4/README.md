...
使用静态Tensor编程方法进行add算子的编程，基于add_custom_v3，修改地址分配逻辑，消除bank冲突。
...
│   └── add_custom_v4.asc           // Ascend C算子实现 & 调用样例
```
...
<tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">add_custom_v4</td></tr>
</table>
