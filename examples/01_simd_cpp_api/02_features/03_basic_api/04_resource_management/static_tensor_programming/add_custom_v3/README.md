...
使用静态Tensor编程方法进行add算子的编程，优化double buffer实现，简化判断逻辑，并使用LocalMemAllocator简化代码。
...
│   └── add_custom_v3.asc           // Ascend C算子实现 & 调用样例
```
...
<tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">add_custom_v3</td></tr>
</table>
