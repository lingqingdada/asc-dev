# SetAtomicAdd样例
## 概述
本样例基于SetAtomicAdd为后续的从VECOUT/L0C/L1到GM的数据传输开启原子累加。
...
│   └── set_atomic_add.asc      // Ascend C算子实现 & 调用样例
```
...
- 算子规格：  
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">set_atomic_add_custom</td></tr>
  </table>
