...
## 样例描述
- 样例功能：  
  实现了数据切片搬运样例，支持数据的切片搬运，提取二维的源操作数Tensor[3, 87]数据的子集（提取4个数据段：[0, 16:40], [0, 47:71], [2, 16:40]， [2, 47:71]，共96个float32数据）并连续搬运到二维的目的操作数Tensor[2, 48]。接口资料参考[切片数据搬运](../../../../../../docs/api/context/切片数据搬运.md)。
