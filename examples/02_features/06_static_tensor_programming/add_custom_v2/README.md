...
使用静态Tensor编程方法进行add算子的编程，优化性能，使用double buffer进行流水排布。
...
│   └── add_custom_v2.asc           // Ascend C算子实现 & 调用样例
```
...
<tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">add_custom_v2</td></tr>
</table>
