...
## 概述
本样例演示了SIMD场景下，基于RegBase编程范式的连续对齐搬运算子的核函数直调方法，算子支持单核运行。
...
## 算子描述
- 算子功能：  
  在源操作数和目的操作数地址均32B对齐的情况下，搬运1024个float类型数据。
- 算子规格：
  <table>
  ...
  <tr><td rowspan="1" align="center">核函数名</td><td colspan="4" align="center">move_successive_align_kernel</td></tr>
  </table>
- 算子实现：  
  主要包括以下步骤：
  1. 初始化参数
