...
#ifndef TESTS_API_C_API_NPU_ARCH_3510_UTILS_TEST_LOADALIGN_VLDS_INSTR_UTILS_H
#define TESTS_API_C_API_NPU_ARCH_3510_UTILS_TEST_LOADALIGN_VLDS_INSTR_UTILS_H
...
{                                                                                               \
    ...
    __ubuf__ src_type *src;                                                                     \
                                                                                                \
    MOCKER_CPP(cce_name, void(dst_type &, __ubuf__ src_type *, int32_t, Literal))               \
        .times(1)                                                                               \
...
void c_api_name##_##dst_type##_##dst_type##_##src_type##_Stub(dst_type &dst0, dst_type &dst1,   \
    __ubuf__ src_type *src, int32_t offset, int load_dist) {}                                   \
}                                                                                               \
                                                                                                \
...
{                                                                                               \
    ...
    int32_t offset;                                                                             \
                                                                                                \
    MOCKER_CPP(cce_name, void(dst_type &, dst_type &, __ubuf__ src_type *, int32_t, int))       \
        .times(1)                                                                               \
