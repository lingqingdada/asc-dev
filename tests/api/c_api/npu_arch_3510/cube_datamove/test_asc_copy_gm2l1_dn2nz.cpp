...
__aicore__ inline void copy_gm_to_cbuf_multi_dn2nz_stub(__cbuf__ DTYPE* dst, __gm__ DTYPE* src, uint8_t sid, uint64_t loop1_src_stride, uint8_t l2_cache_ctl, uint16_t n_value,
...
{                                                                                     \
    MOCKER_CPP(copy_gm_to_cbuf_multi_dn2nz, void(__cbuf__ dtype*, __gm__ dtype*, uint8_t, uint64_t, uint8_t, uint16_t,          \
...
{                                                                                              \
    ...
    bool smallc0_en = static_cast<bool>(true);                                            \
                                                                                                    \
    asc_copy_gm2l1_dn2nz_sync(dst, src, loop1_src_stride, l2_cache_ctl, n_value, d_value, loop4_src_stride, smallc0_en);         \
    GlobalMockObject::verify();                                                                 \
}    
