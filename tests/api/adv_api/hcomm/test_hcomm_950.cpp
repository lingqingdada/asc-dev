...
Channel GetChannel()
{
    ...
    channel.cqContextAddr->ctx.rdmaCqContext.headAddr = reinterpret_cast<uint64_t>(cqhead);
    channel.cqContextAddr->ctx.rdmaCqContext.tailAddr = reinterpret_cast<uint64_t>(cqtail);
