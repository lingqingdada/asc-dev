...
整个过程的示例代码如下（伪代码）。完整样例请参考[MatmulLeakyRelu](https://gitcode.com/cann/asc-devkit/tree/master/examples/01_simd_cpp_api/00_introduction/03_fusion_operation/matmul_leakyrelu)。
