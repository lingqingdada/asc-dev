...
-   [入门教程](入门教程/什么是Ascend-C.md)
    -   [什么是Ascend C](入门教程/什么是Ascend-C.md)
    -   [环境准备](入门教程/环境准备.md)
    -   [快速入门](入门教程/快速入门/简介.md)
        -   [简介](入门教程/快速入门/简介.md)
        -   [基于SIMD编程](入门教程/快速入门/基于SIMD编程/HelloWorld.md)
...
-   [编程指南](编程指南/本文档组织结构.md)
    ...
    -   [编程模型](编程指南/编程模型/异构并行编程模型.md)
        -   [异构并行编程模型](编程指南/编程模型/异构并行编程模型.md)
        -   [编程模型概述](编程指南/编程模型/编程模型概述.md)
        -   [AI Core SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/抽象硬件架构.md)
            -   [抽象硬件架构](编程指南/编程模型/AI-Core-SIMD编程/抽象硬件架构.md)
            -   [核函数](编程指南/编程模型/AI-Core-SIMD编程/核函数.md)
            -   [SIMD编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/基于TPipe和TQue编程.md)
                -   [基于TPipe和TQue编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/基于TPipe和TQue编程.md)
                -   [静态Tensor编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/静态Tensor编程.md)
                -   [Reg矢量计算编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/Reg矢量计算编程.md)
                -   [基于语言扩展层C API编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD编程/基于语言扩展层C-API编程.md)

            -   [SIMD与SIMT混合编程](编程指南/编程模型/AI-Core-SIMD编程/SIMD与SIMT混合编程.md)

        -   [AI Core SIMT编程](编程指南/编程模型/AI-Core-SIMT编程/抽象硬件架构.md)
    ...
    -   [编译与运行](编程指南/编译与运行/AI-Core-SIMD编译/算子编译简介.md)
        -   [AI Core SIMD编译](编程指南/编译与运行/AI-Core-SIMD编译/算子编译简介.md)
            -   [算子编译简介](编程指南/编译与运行/AI-Core-SIMD编译/算子编译简介.md)
            -   [通过bisheng命令行编译](编程指南/编译与运行/AI-Core-SIMD编译/通过bisheng命令行编译.md)
            -   [常用的编译选项](编程指南/编译与运行/AI-Core-SIMD编译/常用的编译选项.md)
            -   [通过CMake编译](编程指南/编译与运行/AI-Core-SIMD编译/通过CMake编译.md)
            -   [RTC](编程指南/编译与运行/AI-Core-SIMD编译/RTC.md)
            -   [约束说明](编程指南/编译与运行/AI-Core-SIMD编译/约束说明.md)

        -   [AI Core SIMT编译](编程指南/编译与运行/AI-Core-SIMT编译/算子编译简介.md)
            -   [算子编译简介](编程指南/编译与运行/AI-Core-SIMT编译/算子编译简介.md)
            -   [通过bisheng命令行编译](编程指南/编译与运行/AI-Core-SIMT编译/通过bisheng命令行编译.md)
            -   [常用的编译选项](编程指南/编译与运行/AI-Core-SIMT编译/常用的编译选项.md)
            -   [通过CMake编译](编程指南/编译与运行/AI-Core-SIMT编译/通过CMake编译.md)
            -   [约束说明](编程指南/编译与运行/AI-Core-SIMT编译/约束说明.md)

        -   [AI CPU算子编译](编程指南/编译与运行/AI-CPU算子编译.md)
        -   [算子运行](编程指南/编译与运行/算子运行.md)

    -   [语言扩展层](编程指南/语言扩展层/SIMD-BuiltIn关键字.md)
    ...
    -   [C++类库API](编程指南/C++类库API/编程接口概述.md)
        -   [编程接口概述](编程指南/C++类库API/编程接口概述.md)
        -   [基础API](编程指南/C++类库API/基础API/概述.md)
            -   [概述](编程指南/C++类库API/基础API/概述.md)
            -   [接口分类说明](编程指南/C++类库API/基础API/接口分类说明/连续计算API.md)
                -   [连续计算API](编程指南/C++类库API/基础API/接口分类说明/连续计算API.md)
                -   [高维切分API](编程指南/C++类库API/基础API/接口分类说明/高维切分API.md)

            -   [常用操作速查指导](编程指南/C++类库API/基础API/常用操作速查指导/如何使用掩码操作API.md)
                -   [如何使用掩码操作API](编程指南/C++类库API/基础API/常用操作速查指导/如何使用掩码操作API.md)
                -   [如何使用归约计算API](编程指南/C++类库API/基础API/常用操作速查指导/如何使用归约计算API.md)

        -   [高阶API](编程指南/C++类库API/高阶API/概述.md)
            -   [概述](编程指南/C++类库API/高阶API/概述.md)
            -   [常用操作速查指导](编程指南/C++类库API/高阶API/常用操作速查指导/如何使用Tiling依赖的头文件.md)
        ...
        -   [Utils API](编程指南/C++类库API/Utils-API.md)

    -   [硬件实现](编程指南/硬件实现/基本架构.md)
        -   [基本架构](编程指南/硬件实现/基本架构.md)
        -   [架构规格](编程指南/硬件实现/架构规格/NPU架构版本200x.md)
            ...
            -   [NPU架构版本351x](编程指南/硬件实现/架构规格/NPU架构版本351x.md)

        -   [硬件约束](编程指南/硬件实现/硬件约束/NPU架构版本200x.md)
            -   [NPU架构版本200x](编程指南/硬件实现/硬件约束/NPU架构版本200x.md)
            -   [NPU架构版本220x](编程指南/硬件实现/硬件约束/NPU架构版本220x.md)

    -   [调试调优](编程指南/调试调优/概述.md)
        -   [概述](编程指南/调试调优/概述.md)
    ...
    -   [兼容性指南](编程指南/兼容性指南.md)
    -   [概念原理和术语](编程指南/概念原理和术语/术语表.md)
        -   [术语表](编程指南/概念原理和术语/术语表.md)
        -   [神经网络和算子](编程指南/概念原理和术语/神经网络和算子/算子基本概念.md)
            -   [算子基本概念](编程指南/概念原理和术语/神经网络和算子/算子基本概念.md)
            -   [数据排布格式](编程指南/概念原理和术语/神经网络和算子/数据排布格式.md)

        -   [编程模型设计原理](编程指南/概念原理和术语/编程模型设计原理.md)
        -   [内存访问原理](编程指南/概念原理和术语/内存访问原理/Scalar读写数据.md)
            -   [Scalar读写数据](编程指南/概念原理和术语/内存访问原理/Scalar读写数据.md)

        -   [性能优化技术原理](编程指南/概念原理和术语/性能优化技术原理/DoubleBuffer.md)
            -   [DoubleBuffer](编程指南/概念原理和术语/性能优化技术原理/DoubleBuffer.md)

    -   [附录](编程指南/附录/C++标准支持/概述.md)
        -   [C++标准支持](编程指南/附录/C++标准支持/概述.md)
            -   [概述](编程指南/附录/C++标准支持/概述.md)
            -   [C/C++语法限制](编程指南/附录/C++标准支持/C-C++语法限制/特性.md)
                -   [特性](编程指南/附录/C++标准支持/C-C++语法限制/特性.md)
                -   [函数](编程指南/附录/C++标准支持/C-C++语法限制/函数.md)

        -   [工程化算子开发](编程指南/附录/工程化算子开发/概述.md)
            ...
            -   [Host侧Tiling实现](编程指南/附录/工程化算子开发/Host侧Tiling实现/基本流程.md)
        ...
        -   [算子入图（GE图）开发](编程指南/附录/算子入图（GE图）开发/概述.md)
        ...
        -   [AI框架算子适配](编程指南/附录/AI框架算子适配/概述.md)
            -   [概述](编程指南/附录/AI框架算子适配/概述.md)
            -   [PyTorch框架](编程指南/附录/AI框架算子适配/PyTorch框架.md)
            -   [ONNX框架](编程指南/附录/AI框架算子适配/ONNX框架/适配插件开发.md)
        ...
        -   [常用操作](编程指南/附录/常用操作/如何开发动态输入算子.md)
            ...
            -   [如何在矢量编程时使能Vector Core](编程指南/附录/常用操作/如何在矢量编程时使能Vector-Core.md)
...
-   [算子实践参考](算子实践参考/本文档组织结构.md)
    ...
    -   [异构计算](算子实践参考/异构计算.md)
    -   [SIMD算子实现](算子实践参考/SIMD算子实现/概述.md)
        -   [概述](算子实践参考/SIMD算子实现/概述.md)
        -   [矢量编程](算子实践参考/SIMD算子实现/矢量编程/概述.md)
        ...
        -   [矩阵编程（高阶API）](算子实践参考/SIMD算子实现/矩阵编程（高阶API）/基础知识.md)
        ...
        -   [融合算子编程](算子实践参考/SIMD算子实现/融合算子编程/CV融合/基础知识.md)
    ...
    -   [SIMD算子性能优化](算子实践参考/SIMD算子性能优化/优化建议总览表.md)
        ...
        -   [流水编排](算子实践参考/SIMD算子性能优化/流水编排/使能DoubleBuffer.md)
            -   [使能DoubleBuffer](算子实践参考/SIMD算子性能优化/流水编排/使能DoubleBuffer.md)
            -   [使能Iterate或IterateAll异步接口避免AIC/AIV同步依赖](算子实践参考/SIMD算子性能优化/流水编排/使能Iterate或IterateAll异步接口避免AIC-AIV同步依赖.md)

        -   [内存访问](算子实践参考/SIMD算子性能优化/内存访问/尽量一次搬运较大的数据块.md)
            ...
            -   [避免Unified Buffer的bank冲突](算子实践参考/SIMD算子性能优化/内存访问/避免Unified%20Buffer的bank冲突/概述.md)
                -   [概述](算子实践参考/SIMD算子性能优化/内存访问/避免Unified%20Buffer的bank冲突/概述.md)
                -   [避免bank冲突（NPU架构版本220x）](算子实践参考/SIMD算子性能优化/内存访问/避免Unified%20Buffer的bank冲突/避免bank冲突（NPU架构版本220x）.md)
                -   [避免bank冲突（Ascend 950PR/Ascend 950DT）](算子实践参考/SIMD算子性能优化/内存访问/避免Unified%20Buffer的bank冲突/避免bank冲突（Ascend-950PR-Ascend-950DT）.md)
    ...
    -   [优秀实践](算子实践参考/优秀实践/FlashAttention算子性能调优案例.md)
        ...
        -   [Matmul性能调优案例](算子实践参考/优秀实践/Matmul性能调优案例/Matmul性能优化策略总览.md)
            ...
            -   [Matmul高阶API使能L2 Cache切分](算子实践参考/优秀实践/Matmul性能调优案例/Matmul高阶API使能L2-Cache切分.md)
            ...
            -   [Matmul高阶API使能MTE2 Preload](算子实践参考/优秀实践/Matmul性能调优案例/Matmul高阶API使能MTE2-Preload.md)

        -   [SIMT实现InsertHashTable算子案例](算子实践参考/优秀实践/SIMT实现InsertHashTable算子案例.md)

-   [兼容性迁移指南](兼容性迁移指南/兼容性说明.md)
    -   [兼容性说明](兼容性迁移指南/兼容性说明.md)
    -   [351x架构迁移指导](兼容性迁移指南/351x架构迁移指导/220x到351x架构变更.md)
        -   [220x到351x架构变更](兼容性迁移指南/351x架构迁移指导/220x到351x架构变更.md)
        -   [220x迁移351x指导](兼容性迁移指南/351x架构迁移指导/220x迁移351x指导/基础API迁移指导.md)
            -   [基础API迁移指导](兼容性迁移指南/351x架构迁移指导/220x迁移351x指导/基础API迁移指导.md)
            -   [高阶API迁移指导](兼容性迁移指南/351x架构迁移指导/220x迁移351x指导/高阶API迁移指导.md)
            -   [算子编译迁移指导](兼容性迁移指南/351x架构迁移指导/220x迁移351x指导/算子编译迁移指导.md)
