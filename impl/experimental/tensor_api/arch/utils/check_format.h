...
public:
    ...
    __aicore__ inline static constexpr void CheckZZTemplate()
    {
        ...
        static_assert(
            Std::is_same_v<ShapeColumn0, Std::Int<C0_ELEMENT<dataType>>>,
        ...
        static_assert(
            Std::is_same_v<StrideRow0, Std::Int<C0_ELEMENT<dataType>>>,
    ...
    __aicore__ inline static constexpr void CheckZNTemplate()
    {
        ...
        using ShapeColumn0 = typename GetFourDimType<T, AttrInfo::SHAPE, AttrInfo::COLUMN, 0>::type;
        static_assert(
            Std::is_same_v<ShapeColumn0, Std::Int<FRACTAL_FIXED>>, "Filter Layout->Shape->Column->ZeroDim must be 16!");
        static_assert(
            Std::is_same_v<ShapeRow0, Std::Int<C0_ELEMENT<dataType>>>,
            "Filter Layout->Shape->Row->ZeroDim must be (is_b4_type<dataType> ? 64 : 32 / sizeof(dataType))!");

        using StrideRow0 = typename GetFourDimType<T, AttrInfo::STRIDE, AttrInfo::ROW, 0>::type;
        using StrideColumn0 = typename GetFourDimType<T, AttrInfo::STRIDE, AttrInfo::COLUMN, 0>::type;
        static_assert(
            Std::is_same_v<StrideColumn0, Std::Int<C0_ELEMENT<dataType>>>,
            "Filter Layout->Stride->Column-ZeroDim must be (is_b4_type<dataType> ? 64 : 32 / sizeof(dataType))!");
        static_assert(Std::is_same_v<StrideRow0, Std::Int<1>>, "Filter Layout->Stride->Row->ZeroDim must be 1!");
    }
    ...
    __aicore__ inline static constexpr void CheckNZTemplate()
    {
        ...
        static_assert(Std::is_same_v<ShapeRow0, Std::Int<FRACTAL_FIXED>>, "Layout->Shape->Row->ZeroDim must be 16!");
        static_assert(
            Std::is_same_v<ShapeColumn0, Std::Int<C0_ELEMENT<type>>>,
        ...
        static_assert(
            Std::is_same_v<StrideRow0, Std::Int<C0_ELEMENT<type>>>,
    ...
    __aicore__ inline static constexpr void CheckNDFp8Template()
    {
        ...
        static_assert(
            Std::is_same_v<ShapeColumn0, Std::Int<1>>, "CopyCbufToFB Layout->Shape->Column->ZeroDim must be 1!");
        ...
        static_assert(
            Std::is_same_v<StrideColumn0, Std::Int<0>>, "CopyCbufToFB Layout->Stride->Column->ZeroDim must be 0!");
        static_assert(
            Std::is_same_v<StrideColumn1, Std::Int<MX_SCALE_K0>>,
    ...
    __aicore__ inline static constexpr void CheckL0CNZTemplate()
    {
        ...
        static_assert(Std::is_same_v<ShapeRow0, Std::Int<FRACTAL_FIXED>>, "Layout->Shape->Row->ZeroDim must be 16!");
        static_assert(
            Std::is_same_v<ShapeColumn0, Std::Int<FRACTAL_FIXED>>, "Layout->Shape->Column->ZeroDim must be 16!");

        using StrideRow0 = typename GetFourDimType<T, AttrInfo::STRIDE, AttrInfo::ROW, 0>::type;
        using StrideColumn0 = typename GetFourDimType<T, AttrInfo::STRIDE, AttrInfo::COLUMN, 0>::type;
        static_assert(Std::is_same_v<StrideRow0, Std::Int<FRACTAL_FIXED>>, "Layout->Stride->Row->ZeroDim must be 16!");
        static_assert(Std::is_same_v<StrideColumn0, Std::Int<1>>, "Layout->Stride->Column->ZeroDim must be 1!");
    }
