...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ int8_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ uint8_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ int16_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ uint16_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ int32_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ int64_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ uint32_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ half* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ float* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ bfloat16_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        vstar(src, dst);
    }
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ fp8_e4m3fn_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        __ubuf__ float8_e4m3_t* dst_tmp = reinterpret_cast<__ubuf__ float8_e4m3_t*>(dst);
        vstar(src, dst_tmp);
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ fp8_e5m2_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        __ubuf__ float8_e5m2_t* dst_tmp = reinterpret_cast<__ubuf__ float8_e5m2_t*>(dst);
        vstar(src, dst_tmp);
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ fp8_e8m0_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        __ubuf__ float8_e8m0_t* dst_tmp = reinterpret_cast<__ubuf__ float8_e8m0_t*>(dst);
        vstar(src, dst_tmp);
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ fp4x2_e2m1_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        __ubuf__ float4_e2m1x2_t* dst_tmp = reinterpret_cast<__ubuf__ float4_e2m1x2_t*>(dst);
        vstar(src, dst_tmp);
...
__simd_callee__ inline void asc_storeunalign_post_impl(__ubuf__ fp4x2_e1m2_t* dst, vector_store_align src)
{
    if ASC_IS_AIV {
        __ubuf__ float4_e1m2x2_t* dst_tmp = reinterpret_cast<__ubuf__ float4_e1m2x2_t*>(dst);
        vstar(src, dst_tmp);
