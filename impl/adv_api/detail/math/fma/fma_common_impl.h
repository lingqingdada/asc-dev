...
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_FMA_FMA_COMMON_IMPL_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_FMA_FMA_COMMON_IMPL_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_FMA_FMA_COMMON_IMPL_H
#endif
