...
#pragma message("impl/adv_api/detail/math/logical_and/logical_and_common_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/math/logical_and.h\"\" and use public functions or variables defined in interface headers files.")
#define _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_LOGICAL_AND_LOGICAL_AND_COMMON_IMPL_H
#endif
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_LOGICAL_AND_LOGICAL_AND_COMMON_IMPL_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_MATH_LOGICAL_AND_LOGICAL_AND_COMMON_IMPL_H
#endif
