...
#pragma message("impl/adv_api/detail/reduce/reduce_max/reduce_max_v220_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/reduce/reduce.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H__
#endif

#ifndef IMPL_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H_
#define IMPL_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H_
...
#include "../../api_check/kernel_check/reduce/reduce_max/reduce_max_check.h"
...
__aicore__ inline void ReduceMaxImpl(const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor,
                                      ...
                                      bool srcInnerPad)
{
    ...
    CHECK_FUNC_HIGHLEVEL_API(ReduceMax, (T, pattern), (dstTensor, srcTensor, sharedTmpBuffer, srcShape, srcInnerPad, padLast));
...
#endif // IMPL_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H_

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MAX_REDUCE_MAX_V220_IMPL_H__
#endif
