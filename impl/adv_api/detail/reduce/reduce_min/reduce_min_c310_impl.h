...
#pragma message("impl/adv_api/detail/reduce/reduce_min/reduce_min_c310_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/reduce/reduce.h\"\" and use public functions or variables defined in interface headers files.")
#define _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#define UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MIN_REDUCE_MIN_C310_IMPL_H
#endif
    ...
    __ubuf__ T *tmpAddr, const uint32_t srcShape[])
{
    if ((srcShape[1] * sizeof(T)) % 32 == 0) {
        ReduceARImpl<T, Reg::RegTraitNumTwo,
            ...
            Reg::ReduceMin<T, Reg::MaskMergeMode::ZEROING,
    ...
    __ubuf__ T *tmpAddr, const uint32_t srcShape[])
{
    ...
    if ((srcShape[1] * sizeof(T)) % 32 == 0 || srcShape[1] == 1) {
        ReduceARImpl<T, Reg::RegTraitNumOne,
            ...
            isReuseSource, ReduceType::IS_REDUCE_MIN>(
                dstAddr, srcAddr, tmpAddr, srcShape[0], srcShape[1]);
    } else {
...
#if defined(UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MIN_REDUCE_MIN_C310_IMPL_H)
#undef _ASCENDC_INCLUDE_INTERNAL_HEADERS_
#undef UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_REDUCE_MIN_REDUCE_MIN_C310_IMPL_H
#endif
