...
class CheckFuncClassDigamma : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    ...
    __aicore__ inline CheckFuncClassDigamma(__gm__ const char *apiName) : SingleTensorCheckFuncBasicClass(apiName), MultipleTensorCheckFuncBasicClass(apiName),
