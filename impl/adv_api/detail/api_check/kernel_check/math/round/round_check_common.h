...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_ROUND_CHECK_COMMON_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_ROUND_CHECK_COMMON_H__
#endif
