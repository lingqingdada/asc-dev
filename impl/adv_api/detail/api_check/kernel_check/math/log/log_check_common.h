...
#pragma message("impl/adv_api/detail/api_check/kernel_check/math/log/log_check_common.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/math/log.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOG_CHECK_COMMON_H__
#endif

#ifndef IMPL_API_CHECK_KERNEL_CHECK_MATH_LOG_LOG_CHECK_COMMON_H_
#define IMPL_API_CHECK_KERNEL_CHECK_MATH_LOG_LOG_CHECK_COMMON_H_
...
class CheckFuncClassLog : public SingleTensorCheckFuncBasicClass, public MultipleTensorCheckFuncBasicClass,
    public CalCountCheckFuncBasicClass, public ReuseSourceCheckFuncBasicClass, public DataTypeCheckFuncBasicClass {
public:
    ...
    __aicore__ inline CheckFuncClassLog(__gm__ const char *apiName) :
        ...
        SingleTensorCheckFuncBasicClass(apiName), MultipleTensorCheckFuncBasicClass(apiName), CalCountCheckFuncBasicClass(apiName) {};
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor,
        ...
        CheckFuncClassMathCommon::CommonVerifyNoTmpBufReuse<T, isReuseSource>(dstTensor, srcTensor, sharedTmpBuffer, calCount);
    };
};

template <typename T, bool isReuseSource = false>
class CheckFuncClassLog10 : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
#endif // IMPL_API_CHECK_KERNEL_CHECK_MATH_LOG_LOG_CHECK_COMMON_H_

#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOG_CHECK_COMMON_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_LOG_CHECK_COMMON_H__
#endif
