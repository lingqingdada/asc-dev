...
class CheckFuncClassLgamma : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    ...
    __aicore__ inline CheckFuncClassLgamma(__gm__ const char *apiName) :
        ReuseSourceCheckFuncBasicClass(apiName), DataTypeCheckFuncBasicClass(apiName), CalCountCheckFuncBasicClass(apiName),
