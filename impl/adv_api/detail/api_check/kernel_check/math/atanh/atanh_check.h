...
#define IMPL_API_CHECK_KERNEL_CHECK_MATH_ATANH_ATANH_CHECK_H_

#if defined(__NPU_ARCH__) && (__NPU_ARCH__ == 2002 || __NPU_ARCH__ == 2201)
#include "atanh_check_common.h"
#else
#include "atanh_check_aicore.h"
#endif
...
__aicore__ inline void CheckFuncAtanh(__gm__ const char *apiName, const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor,
    const LocalTensor<uint8_t>& sharedTmpBuffer, const uint32_t calCount)
{
    CheckFuncClassAtanh<T, isReuseSource> checkFun(apiName);
