...
class CheckFuncClassTrunc : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    ...
    __aicore__ inline CheckFuncClassTrunc(__gm__ const char *apiName) : SingleTensorCheckFuncBasicClass(apiName), 
        DataTypeCheckFuncBasicClass(apiName), CalCountCheckFuncBasicClass(apiName),
        ReuseSourceCheckFuncBasicClass(apiName), MultipleTensorCheckFuncBasicClass(apiName) {};
