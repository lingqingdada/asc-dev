...
class CheckFuncClassCos : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<T>& dstTensor, const LocalTensor<T>& srcTensor,
        ...
        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(srcTensor, dstTensor, sharedTmpBuffer),
