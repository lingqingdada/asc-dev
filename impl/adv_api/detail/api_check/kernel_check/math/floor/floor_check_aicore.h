...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FLOOR_CHECK_AICORE_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_FLOOR_CHECK_AICORE_H__
#endif
