...
class CheckFuncClassCosh : public CheckFuncClassMathCommon {
public:
    __aicore__ inline CheckFuncClassCosh(){};
    __aicore__ inline CheckFuncClassCosh(__gm__ const char* apiName) : CheckFuncClassMathCommon(apiName){};
