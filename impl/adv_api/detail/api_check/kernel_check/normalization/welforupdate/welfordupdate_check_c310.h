        ...
        const WelfordUpdateParam& para)
    {
        ...
        ASCENDC_ASSERT(
            ((para.abComputeLength <= para.abLength && para.abComputeLength > 0) || HighLevelAPIParametersPrint), {
                KERNEL_LOG(KERNEL_ERROR,
                    "[WelfordUpdate] The para.abComputeLength is %u, should be positive and less than or equal to para.abLength.",
        ...
        ASCENDC_ASSERT((para.rnLength * para.abLength <= outputMean.GetSize() || HighLevelAPIParametersPrint), {
            KERNEL_LOG(KERNEL_ERROR,
                ...
                "the product of para.rnLength and para.abLength should not larger than outputMean and outputVariance size %u.",
        ...
        ASCENDC_ASSERT((para.rnLength * para.abLength <= inputMean.GetSize() || HighLevelAPIParametersPrint), {
            KERNEL_LOG(KERNEL_ERROR,
                "[WelfordUpdate] The para.rnLength is %u, para.abLength is %u, "
                "the product of para.rnLength and para.abLength should not larger than inputMean and inputVariance size %u.",
