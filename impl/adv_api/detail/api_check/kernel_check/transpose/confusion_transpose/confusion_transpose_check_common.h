...
public:
    ...
    __aicore__ inline TransposeTypeCheckFuncBasicClass(__gm__ const char *apiName) 
    {
        this->apiName = apiName;
    };

    template <typename U>
    __aicore__ inline void TransposeTypeCheck(const TransposeType curType, U validTypeTuple, __gm__ const char* validTypeString) 
    {
...
private:
    ...
    __aicore__ inline void TransposeTypeCheckLoopCheck(const TransposeType checkType, U posTuple,
                                                       __gm__ const char *posString, Std::index_sequence<Is...>) 
    {
        ...
        auto typeName = FindStringFromTuple(checkType, typeTuple, typeStringTuple,
                                           tuple_sequence<decltype(typeTuple)>{});
        ...
        ASCENDC_ASSERT((status) || HighLevelAPIParametersPrint, {
            KERNEL_LOG(KERNEL_ERROR,
                       ...
                       "current type is %s.",
                       apiName, posString,
                       FindStringFromTuple(checkType, typeTuple, typeStringTuple,
                                           tuple_sequence<decltype(typeTuple)>{}));
        });
...
template <typename T>
class CheckFuncClassConfusionTranspose : public DataTypeCheckFuncBasicClass, public SingleTensorCheckFuncBasicClass,
    public MultipleTensorCheckFuncBasicClass, public TransposeTypeCheckFuncBasicClass {
public:
    __aicore__ inline CheckFuncClassConfusionTranspose() {};
    __aicore__ inline CheckFuncClassConfusionTranspose(__gm__ const char *apiName) : DataTypeCheckFuncBasicClass(apiName),
        SingleTensorCheckFuncBasicClass(apiName), MultipleTensorCheckFuncBasicClass(apiName), TransposeTypeCheckFuncBasicClass(apiName) {};
