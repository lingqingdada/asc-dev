...
#pragma message( \
    "impl/adv_api/detail/api_check/kernel_check/reduce/reduce_any/reduce_any_check_c310.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/reduce/reduce.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_ANY_CHECK_C310_H__
#endif
...
public:
        ...
        const uint32_t srcShape[], const bool srcInnerPad, const uint32_t padLast)
    {
        ...
        ASCENDC_ASSERT((srcShape[1] * sizeof(T) % ONE_BLK_SIZE == 0 || HighLevelAPIParametersPrint), {
            KERNEL_LOG(
                KERNEL_ERROR,
                "[ReduceAny] The result of srcShape[1] * sizeof(T) cannot be %u, "
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_ANY_CHECK_C310_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_ANY_CHECK_C310_H__
#endif
