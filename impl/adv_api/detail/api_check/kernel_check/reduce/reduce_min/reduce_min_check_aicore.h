...
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_MIN_CHECK_AICORE_H__
#endif
...
class CheckFuncClassReduceMin {
public:
    __aicore__ inline CheckFuncClassReduceMin() {};
    __aicore__ inline CheckFuncClassReduceMin(__gm__ const char *apiName) {};
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_MIN_CHECK_AICORE_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_REDUCE_MIN_CHECK_AICORE_H__
#endif
