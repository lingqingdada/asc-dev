...
class CheckFuncClassSwiGLU : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    ...
    __aicore__ inline CheckFuncClassSwiGLU(__gm__ const char *apiName) : DataTypeCheckFuncBasicClass(apiName),
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<T> &dstTensor, const LocalTensor<T> &srcTensor0,
        ...
        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(srcTensor0, dstTensor,
...
public:
    ...
    __aicore__ inline void VerifyingParameters(const LocalTensor<T> &dstTensor, const LocalTensor<T> &srcTensor0,
        ...
        ASCENDC_ASSERT(((dstTensor.GetSize() == srcTensor0.GetSize() && srcTensor0.GetSize() == srcTensor1.GetSize()) ||
            HighLevelAPIParametersPrint), { KERNEL_LOG(KERNEL_ERROR,
            "[SoftMaxFlashV2] The dstTensor size is %u, srcTensor0 size %u, srcTensor1 size is %u, they should be equal.",
