...
__aicore__ inline void CheckFuncSwish(
    __gm__ const char* apiName, const LocalTensor<T>& dstLocal, const LocalTensor<T>& srcLocal, uint32_t dataSize,
    const T scalarValue)
{
