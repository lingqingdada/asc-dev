...
class CheckFuncClassSwish : public DataTypeCheckFuncBasicClass, public CalCountCheckFuncBasicClass,
...
public:
    __aicore__ inline void VerifyingParameters(const LocalTensor<T> &dstLocal, const LocalTensor<T> &srcLocal,
        ...
        SingleTensorCheckFuncBasicClass::TensorVerifyingParameters(VA_ARGS_TO_MAKE_TUPLE(dstLocal, srcLocal),
