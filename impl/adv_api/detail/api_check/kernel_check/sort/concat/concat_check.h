...
#pragma message( \
    "impl/adv_api/detail/api_check/kernel_check/sort/concat/concat_check.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future.")
...
#include "concat_check_common.h"
#else
#include "concat_check_aicore.h"
#endif
...
__aicore__ inline void CheckFuncConcat(__gm__ const char* apiName, Args... args)
{
    CheckFuncClassConcat<T> checkFun(apiName);
