...
{
    CHECK_FUNC_HIGHLEVEL_API(AscendQuant, (T, isReuseSource, config),
        (dstTensor, srcTensor, sharedTmpBuffer, scaleTensor, offset, scaleCount,
        calCount));
