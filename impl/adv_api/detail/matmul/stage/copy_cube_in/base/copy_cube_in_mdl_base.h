...
#ifndef IMPL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_MDL_BASE_H
#define IMPL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_MDL_BASE_H
...
namespace Detail {
/*
    CopyCubeInMDLBase is considered entirely experimental.
...
public:
    ...
    __aicore__ inline CopyCubeInMDLBase() = default;
    __aicore__ inline ~CopyCubeInMDLBase() = default;
...
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DETAIL_MATMUL_STAGE_COPY_CUBE_IN_BASE_COPY_CUBE_IN_MDL_BASE_H__
#endif