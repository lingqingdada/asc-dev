...
#pragma message("impl/adv_api/detail/matmul/resource/cube_out_buffer/cube_out_buffer_extend.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
public:
    ...
    __aicore__ inline void SetTensor(const LocalTensor<L0cT>& tensor)
    {
        cMatrix_ = tensor;
    }
