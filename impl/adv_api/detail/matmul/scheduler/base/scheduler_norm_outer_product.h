...
#pragma message("impl/adv_api/detail/matmul/scheduler/base/scheduler_norm_outer_product.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
private:
    __aicore__ inline void ComputeMultiIterOrderN(bool enPartialSum)
    {
        ...
        do {
            ...
            // CopyIn
            LocalTensor<TransBT> b1 = MATMUL_MODULE(CopyCubeInB)->LoadData(
    ...
    __aicore__ inline void ComputeLoopM(const LocalTensor<TransBT>& b1, const SplitParams& aL0Params,
        const SplitParams& bL0Params, const bool enPartialSum, const int32_t kOuterIdx, const bool isATranspose, const bool isBTranspose)
    {
        ...
        for (int dbInner = 0; dbInner < l0aDBLoop; dbInner++) {
            ...
            LocalTensor<TransAT> a1 = MATMUL_MODULE(CopyCubeInA)->LoadData(MATMUL_MODULE(MLoop)->GetInnerIdx() + dbInner,
            ...
            LocalTensor<TransBT> b2 = SplitB(b1, bL0Params, posB, bL0Params.axisL1Len, bL0Params.axisL0Len, kL0Len, isBTranspose);
            bufferPool.EnQue();
            bufferPool.DeQue();
    ...
    __aicore__ inline void ComputeMultiIterOrderM(bool enPartialSum)
    {
        ...
        do {
            int32_t kOuterIdx = MATMUL_MODULE(KLoop)->GetOuterIdx();
            // CopyIn
            LocalTensor<TransAT> a1 = MATMUL_MODULE(CopyCubeInA)->LoadData(MATMUL_MODULE(MLoop)->GetInnerIdx(),
    ...
    __aicore__ inline void ComputeLoopN(const LocalTensor<TransAT>& a1, LocalTensor<BiasT>& bias, const SplitParams& aL0Params,
        const SplitParams& bL0Params, const bool enPartialSum, const int32_t kOuterIdx, const bool isATranspose, const bool isBTranspose)
    {
        bool sL0CInit = false;
        bool sL0CLast = false;
        ...
        for (int dbInner = 0; dbInner < l0bDBLoop; dbInner++) {
            ...
            LocalTensor<TransBT> b1 = MATMUL_MODULE(CopyCubeInB)->LoadData(kOuterIdx,
            ...
            auto posB = (MATMUL_MODULE(NLoop)->GetInnerIdx() + dbInner) * MATMUL_MODULE(KLoop)->GetTotalIter() +
                MATMUL_MODULE(KLoop)->GetInnerIdx();
            LocalTensor<TransAT> a2 = SplitA(a1, aL0Params, posA, aL0Params.axisL1Len, aL0Params.axisL0Len, kL0Len, isATranspose);
    ...
    __aicore__ inline LocalTensor<TransAT> SplitA(const LocalTensor<TransAT>& a1, const SplitParams& aL0Params,
    ...
    __aicore__ inline LocalTensor<TransBT> SplitB(const LocalTensor<TransBT>& b1, const SplitParams& bL0Params,
