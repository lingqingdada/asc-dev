...
#pragma message( \
    "impl/adv_api/detail/matmul/scheduler/iterator/k_loop/k_loop_mdl_reorder.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
#define __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#define __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_REORDER_H__
#endif
...
class KLoop<
    ...
    enable_if_t<
        !MatmulFeatureTrait<MM_CFG>::IsNeedUB() && DoMatmulMDL(MM_CFG) && IsKdimReorderLoad<MM_CFG> &&
        !HasScalePosition<A_TYPE>::value>> : public KLoopMDLBase<IMPL, TRANS_T, A_TYPE, MM_CFG> {
...
public:
    ...
    __aicore__ inline bool FirstOuterIter() const { return BASE_MODULE::outerIdx_ == minStepKStartOuterIdx_; }
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_REORDER_H__)
#undef __ASCENDC_INCLUDE_INTERNAL_HEADERS__
#undef __UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DETAIL_MATMUL_SCHEDULER_ITERATOR_K_LOOP_K_LOOP_MDL_REORDER_H__
#endif