...
#pragma message("impl/adv_api/detail/matmul/scheduler/iterator/n_loop/n_loop_norm_outer_product.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
class NLoop<IMPL, A_TYPE, MM_CFG, enable_if_t<(isNormEnableScheduler<A_TYPE, MM_CFG> || IsBmmSingleScheduler<A_TYPE, MM_CFG>) &&
...
#if defined(__UNDEF_ASCENDC_INCLUDE_INTERNAL_HEADERS_DETAIL_MATMUL_SCHEDULER_ITERATOR_N_LOOP_N_LOOP_NORM_OUTER_PRODUCT_H__)
