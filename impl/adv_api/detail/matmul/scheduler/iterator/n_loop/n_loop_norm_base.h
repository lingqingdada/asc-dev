...
#pragma message("impl/adv_api/detail/matmul/scheduler/iterator/n_loop/n_loop_norm_base.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
protected:
    ...
    __aicore__ inline void UpdateOuterParams()
    {
        if constexpr (IsBasicN(MM_CFG)) {
            ...
            innerIter_ =
                (totalIter_ - innerStartIdx_) > static_cast<uint32_t>(MATMUL_MODULE(MatmulShapeTiling)->GetTiling().GetStepN()) ?
