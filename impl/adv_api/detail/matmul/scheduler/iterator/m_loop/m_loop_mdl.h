...
#pragma message( \
    "impl/adv_api/detail/matmul/scheduler/iterator/m_loop/m_loop_mdl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"adv_api/matmul/matmul.h\"\" and use public functions or variables defined in interface headers files.")
...
class MLoop<
    ...
    enable_if_t<
        ...
        DoMatmulSpecialMDL(MM_CFG)>> : public MLoopMDLBase<IMPL, A_TYPE, MM_CFG> {
