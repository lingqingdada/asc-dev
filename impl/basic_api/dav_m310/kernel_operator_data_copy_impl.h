...
#pragma message("impl/basic_api/dav_m310/kernel_operator_data_copy_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_tensor.h\"\" and use public functions or variables defined in interface headers files.")
    ...
    const DataCopyPadParams& padParams)
{
    ...
    copy_gm_to_ubuf_align(dst, src, 0, static_cast<uint16_t>(intriParams.blockCount), intriParams.blockLen, padParams.leftPadding,
...
__aicore__ inline void DataCopyPadUB2GMImpl(__gm__ T* dst, __ubuf__ T* src, const DataCopyExtParams& intriParams)
{
    ...
    copy_ubuf_to_gm_align(dst, src, 0, static_cast<uint16_t>(intriParams.blockCount), intriParams.blockLen,
        static_cast<uint32_t>(intriParams.srcStride), static_cast<uint32_t>(intriParams.dstStride));
}
...
__aicore__ inline void DataCopyPadL12GMImpl(__gm__ T* dst, __cbuf__ T* src, const DataCopyParams& intriParams)
{
    ...
    copy_cbuf_to_gm_align(dst, src, 0, static_cast<uint16_t>(intriParams.blockCount), intriParams.blockLen,
        static_cast<uint32_t>(intriParams.srcStride), static_cast<uint32_t>(intriParams.dstStride));
}
    ...
    const DataCopyPadParams& padParams)
{
    ...
    copy_gm_to_cbuf_align(dst, src, 0, static_cast<uint16_t>(intriParams.blockCount), intriParams.blockLen, padParams.leftPadding,
        padParams.rightPadding, static_cast<uint32_t>(intriParams.srcStride), static_cast<uint32_t>(intriParams.dstStride));
}
