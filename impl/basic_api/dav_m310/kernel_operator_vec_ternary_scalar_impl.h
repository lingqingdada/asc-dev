...
#pragma message("impl/basic_api/dav_m310/kernel_operator_vec_ternary_scalar_impl.h is an internal header file and must not be used directly. Functions or variables defined in this file may be removed in the future. Please use \"#include \"basic_api/kernel_tpipe.h\"\" and use public functions or variables defined in interface headers files.")
                                          ...
                                          const UnaryRepeatParams& repeatParams)
{
    ...
    {
        vector_bool preg;
        plds(preg, ((__ubuf__ uint32_t*)sharedTmpBuffer), 0, US);
        NORMAL_AXPY_IMPL(dst, src, scalarValue, repeatTime, repeatParams, preg, 16);
    }
    AscendCUtils::FreeTemporaryBuffer<uint64_t>(sharedTmpBuffer);
}
